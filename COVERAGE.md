...
| Go expression parser and evaluator | same | 91.1% |
| Go HTTP adapter | same | 98.2% |
| Go overall, including executable entry point | `cd backend && go tool cover -func=coverage.out` | 88.3% |
| React calculator and API client modules | `cd frontend && npm run test:coverage` | 94.9% |
